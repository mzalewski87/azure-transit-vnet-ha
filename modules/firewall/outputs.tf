...
output "fw1_vm_id" {
  ...
  value       = azurerm_linux_virtual_machine.fw["fw1"].id
}

output "fw2_vm_id" {
  description = "FW2 virtual machine resource ID"
  value       = azurerm_linux_virtual_machine.fw["fw2"].id
}

output "fw1_mgmt_private_ip" {
  description = "FW1 management interface private IP"
  value       = azurerm_network_interface.fw["fw1-mgmt"].private_ip_address
}

output "fw2_mgmt_private_ip" {
  description = "FW2 management interface private IP"
  value       = azurerm_network_interface.fw["fw2-mgmt"].private_ip_address
}

output "fw1_untrust_private_ip" {
  description = "FW1 untrust interface private IP"
  value       = azurerm_network_interface.fw["fw1-untrust"].private_ip_address
}

output "fw2_untrust_private_ip" {
  description = "FW2 untrust interface private IP"
  value       = azurerm_network_interface.fw["fw2-untrust"].private_ip_address
}

output "fw1_trust_private_ip" {
  description = "FW1 trust interface private IP"
  value       = azurerm_network_interface.fw["fw1-trust"].private_ip_address
}
